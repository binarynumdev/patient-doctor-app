...
data class Patient(
  ...
  @SerializedName("doctor_sign") var signature: String = ""
  var photoUrl : String = ""
  var phoneNumber: String = ""
  var practiceName: String = ""

  @SerializedName("patient_sign") var signPatient: String = ""
  ...
  @Ignore @SerializedName("start_address_details") var startAddressDetails: Address? = null
  @Ignore @SerializedName("visit_address_details") var visitAddressDetails: String? = null
  @Ignore @SerializedName("receipt_address_details") var receiptAddressDetails: Address? = null
  ...
  fun isValidatePersonalDetails(): Boolean {
    //Log.e("Patient data" , "${patientID} , ${firstName} ,${lastName} ,${street} ,${houseNumber} ,${city} ,${postCode} ,${birthDate} ,${gender} ,${phoneNumber} ,${practiceName} ")
    ...
    while (eventType != XmlPullParser.END_DOCUMENT) {
      ...
      when (eventType) {
        XmlPullParser.START_TAG ->
            if (tag.equals("AbrechnenderKostentraeger", ignoreCase = true)) {
  ...
  fun isFullyValidated(): Boolean {
    if (target.equals("call")) {
      ...
      if (    isValidatePersonalDetails() &&
              ...
              isValidLogisticDetails() &&
              isValidDoctorDocument() == true
      )
          return true
    }
  ...
  fun encryptToSubmit(rsaPrivateKey: String) {
    ...
    insuranceNumber =
        RSAEncryptionHelper.encryptStringWithPrivateKey(insuranceNumber!!, rsaPrivateKey)

    //        insuranceStatus = RSAEncryptionHelper.encryptStringWithPrivateKey(insuranceStatus,
    // rsaPrivateKey)
  }
